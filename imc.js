const calcular = document.getElementById('calcular');/*cria uma variável cujo valor é fixo*/ 
function imc(){ /*uma função é um procedimento de JavaScript, um conjunto de instruções que executa uma tarefa ou calcula um valor*/
    ...
    if(altura !=='' && peso !==''){ /*if é usada para testar uma condição*/
     ...
     } else if (valorIMC <25){ /*else permite ao programa avaliar uma expressão como sendo verdadeira ou falsa*/ 
